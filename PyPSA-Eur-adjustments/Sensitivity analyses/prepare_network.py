...
if __name__ == "__main__":
    if "snakemake" not in globals():
        ...
        snakemake = mock_snakemake(
            "prepare_network", simpl="", clusters="40", ll="v1.0", opts="Ept"
        )
    ...
    for o in opts:
        if "off" in o:
            n.buses = n.buses.loc[~(n.buses.carrier == "MDES")]

            n.stores = n.stores.loc[~(n.stores.carrier == "MDES")]

            n.links = n.links.loc[~((n.links.carrier == "mdes-charger")|(n.links.carrier == "mdes-discharger"))]
            n.carriers = n.carriers.loc[~((n.carriers.index == "mdes-charger")|(n.carriers.index == "mdes-discharger")|(n.carriers.index == "MDES"))]

    # sensitivity analysis of conventional resources elimination        
    for o in opts:
        if "re" in o:
            n.generators = n.generators.loc[~((n.generators.carrier == "nuclear")|(n.generators.carrier == "biomass")|(n.generators.carrier == "geothermal"))]
            n.carriers = n.carriers.loc[~((n.carriers.index == "nuclear")|(n.carriers.index == "biomass")|(n.carriers.index == "geothermal"))]
    ...
    for o in opts:
        ...
        if oo[0].startswith(tuple(suptechs)):
            ...
            attr_lookup = {"p": "p_nom_max", "c": "capital_cost", "m": "marginal_cost", "e":"efficiency"}
