...
def sanitize_carriers(n, config):
    ...
    """
    # add_nice_carrier_names(n, config) in old version expressed in this way
...
def attach_load(n, regions, load, nuts3_shapes, countries, scaling=1.0):
    ...
    n.madd("Load", substation_lv_i, bus=substation_lv_i, p_set=load, carrier="electricity") # in order to plot the balance
...
def attach_wind_and_solar(
    ...
    # TODO: rename tech -> carrier, technologies -> carriers  ->updated: technologies -> carriers, tech -> car
    ...
    for tech in carriers:
        if tech.startswith("OCGT"):
            ...
            n.madd(
                ...
                bus=nuclear["bus"],
                carrier=tech,
                p_nom_extendable=False, # will be set to be false, btu originally use true
                p_nom=0.0,
